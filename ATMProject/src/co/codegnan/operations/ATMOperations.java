...
import com.codegnan.customexceptions.IncorrectPinLimitReacedException;
...
public class ATMOperations {
	...
	public static IATMServices validateCredentials(long cardNumber, int pinNumber)
			throws InvalidCardException, InvalidPinException, IncorrectPinLimitReacedException {
		if (dataBase.containsKey(cardNumber)) {
		...
		if (card.getChances() <= 0) {
			throw new IncorrectPinLimitReacedException(
	...
	public static void main(String[] args) throws NotAOperatorException {
		...
		dataBase.put(22222222222l, new AxisDebitCard(22222222222l, "Santhosh", 50000.0, 2222));
		dataBase.put(333333333333l, new AxisDebitCard(333333333333l, "Pavan", 70000.0, 3333));
		dataBase.put(44444444444l, new AxisDebitCard(44444444444l, "Raja", 85000.0, 4444));
		...
		while (MACHINE_ON) {
			...
			} catch (InvalidPinException | InvalidCardException | IncorrectPinLimitReacedException e) {
